package sunzhengzheng.supermarket.util;



import sunzhengzheng.supermarket.interfaces.*;
import sunzhengzheng.supermarket.impl.*;
import sunzhengzheng.supermarket.util.*;
...
public class ShoppingUtil {
    ...
    public static SuperMarket createSuperMarket() {
        ...
        for (Category category : Category.values()) {
            for (int i = 0; i < merchandisePerCategory; i++) {
                ...
                all[category.ordinal() * merchandisePerCategory + i] = new com.geekbang.supermarket.impl.SimpleMerchandise(
    ...
    public static sunzhengzheng.supermarket.impl.VIPCard getRandomVIPCard() {
